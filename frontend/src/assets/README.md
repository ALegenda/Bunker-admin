...
Адаптивные версии `bunker-cartoon-{480,800,1200}.avif` и `bunker-cartoon-{480,800}.webp` получены из готовой иллюстрации через Sharp без изменения содержания. `<picture>` выбирает подходящий формат и размер: AVIF весит 18–53 КБ вместо исходных 177 КБ; WebP остаётся совместимым запасным вариантом.
