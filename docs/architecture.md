...
`audit_log` сохраняет автора и данные изменений карточек, решений по предложениям, публикаций и доступа. История карточки доступна администратору. Миграционные снимки сохраняются отдельно в `import_backups`.
