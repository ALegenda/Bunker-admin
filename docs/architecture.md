...
При изменении, добавлении, откате и импорте карточек, а также принятии предложения сводка автоматически пересобирается относительно базовой редакции в той же транзакции. Подтверждение проверки сбрасывается. Текст можно отредактировать перед выпуском; следующая правка карточек заменит его автоматически составленной сводкой.
...
| GET/POST /api/proposals | Опытный игрок / администратор |
