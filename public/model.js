...
const fields = ['name', 'description', 'attributes', 'image', 'cardType'];
export function changes(base, cards) {
...
export function fieldChanges(card, before) {
  return fields
...
export function changeStamp(items) {
  let a = 2166136261,
    b = 5381;
  const text = stable(
...
export function migrateImages(cards, imageMap) {
...
export function addImportedEntries(draft, seed) {
